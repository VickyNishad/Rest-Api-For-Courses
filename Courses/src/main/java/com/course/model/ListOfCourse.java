...
public class ListOfCourse {
	...
	public ListOfCourse(String icon, int id, String fullname, String displayname, String shortname, String author_name,
			double price, int rating, String course_validity, String video_link, List<CourseContent> contents,
			String mode, int topic, String section, String total_lecturs, String course_description, String requirments,
			String feedbackString, String level, String total_time, String start_course_date, String status,
			int rate_your_experience) {
		super();
		this.icon = icon;
		this.id = id;
	...
	public String toString() {
		return "ListOfCourse [icon=" + icon + ", id=" + id + ", fullname=" + fullname + ", displayname=" + displayname
				...
				+ rating + ", course_validity=" + course_validity + ", video_link=" + video_link + ", contents="
				+ contents + ", mode=" + mode + ", topic=" + topic + ", section=" + section + ", total_lecturs="
				+ total_lecturs + ", course_description=" + course_description + ", requirments=" + requirments
				+ ", feedbackString=" + feedbackString + ", level=" + level + ", total_time=" + total_time
				+ ", start_course_date=" + start_course_date + ", status=" + status + ", rate_your_experience="
